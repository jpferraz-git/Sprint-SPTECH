...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT email, senha, fkEmpresa FROM usuario WHERE email = '${email}' AND senha = '${senha}' LIMIT 1;
    `;
...
function cadastrar(razaoSocial, nomeFantasia, responsavelLegal, cnpj, estado, cidade, numero, bairro, CEP, logradouro, email, telefone, senha){
    ...
    var instrucaoSql3 = `INSERT INTO cozinha VALUES (default, 'Comercial', 5, '', 3, (SELECT max(idEmpresa) from Empresa));`
